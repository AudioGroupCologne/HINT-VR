...
%This goes from prefabs for camera setups, to input management over the a dedicated audio spatializer.
...
% Describe all scenes/screens that are required.
% Login
% User Creation
% Main Menu
% Training Game
...
\begin{figure}[h!]
    ...
    \subfigure[Login]{\includegraphics[width=0.45\textwidth]{UserLoginB.png}}
    %\hspace{0.2\textwidth}
    \subfigure[Creation]{\includegraphics[width=0.45\textwidth]{UserCreationB.png}}
    %\hspace{0.1\textwidth}
...
\bibitem{CP}{The cocktail-party problem revisited: early processing and selection of multi-talker speech, Adelbert W. Bronkhorst, Date: April 2015, \url{https://www.researchgate.net/publication/274397643_The_cocktail-party_problem_revisited_early_processing_and_selection_of_multi-talker_speech}}
