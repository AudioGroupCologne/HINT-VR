# HINT-VR
HINT-VR is a child-appropriate application for the self-assessment of spatial hearing abilities in VR as presented  in [1].
...
measured non-individual HRTFs (Neumann KU100 dummy head) [4] for the audio spatialization. 

In the current state the Hearing in Nosie Test (HINT) [5] is implemented using the original speech stimuli from the German hearing in noise test featuring a male 
speaker [6]. 
